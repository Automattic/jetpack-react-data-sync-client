...
### Changed
- Return more detailed error messages when an action fails.
- Update dependencies.
...
[0.1.12-alpha]: https://github.com/Automattic/jetpack-react-data-sync-client/compare/v0.1.11...v0.1.12-alpha
